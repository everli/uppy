      ...
      <div class="border border-gray-400 bg-white rounded p-4 flex flex-col justify-between leading-normal shadow-sm hover:shadow-lg mr-2 mt-2">
        ...
        <form @submit.prevent="create" class="mt-2" id="create-application">
          <div class="mt-4">
            ...
            <input id="name" name="name" class="form-input w-full mt-2 rounded-md focus:border-primary-600"
                   type="text"/>
          </div>

          <div class="mt-4">
            <label class="text-gray-700" for="slug">Slug</label>
            <input id="slug" name="slug" class="form-input w-full mt-2 rounded-md focus:border-primary-600"
                   type="text"/>
          </div>
          ...
          <div class="mt-4">
            ...
            <textarea id="description" name="description"
                      class="form-input w-full mt-2 rounded-md focus:border-primary-600"></textarea>
          </div>
          ...
          <div class="flex mt-6">
            <button
                class="px-4 py-2 bg-primary-800 text-white rounded-md hover:bg-primary-600 focus:outline-none focus:bg-primary-700">
              Save
            </button>
          </div>
        </form>
